...
info_table = np.zeros((1,3)) # table for doing PCA and k-means. copy and paste this table into excel or csv and export into Orange data visualisation tool for the classification of the variable stars.
